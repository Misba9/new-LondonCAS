        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button asChild variant="outline" size="lg" className=" text-slate-900 border-white hover:bg-white hover:text-slate-900">
                <Link href="/courses">
                  View Courses
                </Link>
              </Button>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="mailto:hoc@londoncas.co.uk" className="text-sm font-medium hover:text-blue-600">
                      hoc@londoncas.co.uk
                    </a>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    <Mail className="h-4 w-4 text-blue-600 flex-shrink-0" />
                    <div className="text-sm">
                      <a href="mailto:director@londoncas.co.uk" className="font-medium hover:text-blue-600">
